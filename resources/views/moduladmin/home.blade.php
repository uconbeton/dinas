...
<section class="content">
                ...
                <div class="col-md-12">
                  ...
                  <div class="box box-primary">
                    <div class="box-header with-border">
                      <h3 class="box-title">Grafik Pengunjung Tahun {{date('Y')}}</h3>
  ...
  <script>
        $(function () {
          ...
          var areaChartData = {
            labels  : ['January', 'February', 'March', 'April', 'May', 'June', 'July','Agust','Sept','Okt','Nov','Des'],
            // labels  : [
            //     @for($x=1;$x<13;$x++)
            //         {{$x}},
            //     @endfor
